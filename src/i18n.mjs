...
export const T = {
  en: {
    ...
    footer: {
      ...
      salon: 'Salon & beauty', local: 'Local service businesses', training: 'Team training', calc: 'Missed call calculator',
  ...
  zh: {
    ...
    footer: {
      ...
      salon: '美发美容', local: '本地服务商家', training: '团队培训', calc: '漏接电话计算器',
