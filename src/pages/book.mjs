...
const copy = {
  en: {
    ...
    s: {
      ...
      loading: 'Loading times…', none: `No open times in the next 30 days. Text the AI demo at ${SMS_DISPLAY} instead.`,
      ...
      closed: 'It is too close to the appointment to change it online. Text the AI demo at ' + SMS_DISPLAY + '.',
      ...
      error: `Something went wrong. Try again, or text the AI demo at ${SMS_DISPLAY}.`, bookAnother: 'Book a new time',
    },
  },
  zh: {
    ...
    s: {
      ...
      loading: '正在加载时间…', none: `接下来 30 天没有空档，给 AI 演示发短信吧：${SMS_DISPLAY}`,
      ...
      closed: '离通话时间太近，网上改不了了。给 AI 演示发短信：' + SMS_DISPLAY,
      taken: '这个时间刚被约走了，换一个吧。', yes: '确定', no: '返回', moreDays: '更多日期', moreTimes: '更多时间', notFound: '没找到这个预约。',
      error: `出了点问题。再试一次，或者给 AI 演示发短信：${SMS_DISPLAY}`, bookAnother: '重新约一个时间',
    },
  },
};
