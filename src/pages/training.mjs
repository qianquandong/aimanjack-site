...
<div class="paths" style="margin-top:26px"><a class="path tinted" href="/zh/ai-receptionist/"><div class="path-label">产品</div><b>一个接电话、约时间的 AI 前台</b><span>给达拉斯&mdash;沃斯堡的美发美容、医美 spa、诊所、上门服务和维修商家。它按你确认过的信息回答，把预约写进接好的流程，该交接的时候交接。方案每月 $199 起，加一次性安装费。先拨演示线，听它怎么接。</span><div class="path-cta">看 AI 前台</div></a></div></section>
