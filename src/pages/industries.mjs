...
const index = {
  en: { title: 'AI Receptionist by Industry | AI Man Jack', description: 'How the AI receptionist handles DFW salons, med spas, clinics, home-service and repair calls: real scenarios, transcripts, setup needs.',
  ...
  zh: { title: '按行业看 AI 前台 | AI Man Jack', description: 'AI 前台怎么接达拉斯—沃斯堡美发、医美、诊所、上门和维修的来电：真实场景、示例对话、准备清单。',
...
const V = {
  salons: {
    en: { title: 'AI Receptionist for Salons in DFW | AI Man Jack', description: 'DFW hair, nail, lash salons and barbershops: approved prices, the right stylist, reschedules, and clean handoffs.',
    ...
    zh: { title: 'DFW 美发和理发店的 AI 前台 | AI Man Jack', description: '面向达拉斯—沃斯堡美发、美甲、美睫和理发店：只报确认过的价格，约到对的发型师，处理改期，该交接就交接。',
  ...
  'med-spas': {
    en: { title: 'AI Receptionist for Med Spas in DFW | AI Man Jack', description: 'DFW med spa receptionist: books consultations, shares only approved info, never gives medical advice.',
    ...
    zh: { title: 'DFW 医美 spa 的 AI 前台 | AI Man Jack', description: '面向 DFW 医美 spa：预约咨询、只说确认过的信息、不给医疗建议，敏感问题转给员工。',
  ...
  clinics: {
    en: { title: 'AI Receptionist for DFW Clinics | AI Man Jack', description: 'DFW dental, chiropractic, PT and acupuncture clinics: new-patient booking, approved insurance answers, reschedules, your emergency rule.',
    ...
    zh: { title: '牙科、脊椎和 PT 诊所的 AI 前台 | AI Man Jack', description: '面向 DFW 牙科、脊椎、PT 和针灸诊所：新患者排期、确认过的保险清单、改期，以及你定的急诊规则。',
  ...
  'home-services': {
    en: { title: 'AI Receptionist for Home Services | AI Man Jack', description: 'DFW HVAC, plumbing, cleaning, lawn: confirms service area, captures the job, books arrival windows, flags urgent.',
    ...
    zh: { title: 'DFW 上门服务的 AI 前台 | AI Man Jack', description: '面向达拉斯—沃斯堡空调、水管、保洁、草坪：确认范围、记活、约时间窗、紧急立刻推。',
  ...
  'repair-services': {
    en: { title: 'AI Receptionist for DFW Repair Shops | AI Man Jack', description: 'DFW auto, phone, appliance, shoe repair: what you fix, approved price ranges, drop-off bookings, status messages.',
    ...
    zh: { title: 'DFW 维修店的 AI 前台 | AI Man Jack', description: '面向达拉斯—沃斯堡汽车、手机、家电、修鞋：说清修什么、只报确认过的区间、约送修、查进度留言。',
