...
const copy = {
  en: {
    ...
    crumb: 'Contact', h1: 'Talk to our AI demo first, then to Jack.',
    sub: 'No form. Pick whichever is fastest for you.',
    cards: [
      ['Call the AI demo', 'Our AI demo answers 24/7 in English, Spanish or Chinese. Ask what the service costs and ask for a time with Jack.', DEMO_DISPLAY, `tel:${DEMO_TEL}`, 'demo_call_click', T.en.cta.call, true],
      ...
      ['Text the AI demo', 'Our AI demo answers around the clock and can book you a call. Include your business name and what you do.', SMS_DISPLAY, `sms:${SMS_TEL}`, 'sms_click', 'Text ' + SMS_DISPLAY, false],
    ],
  ...
  zh: {
    ...
    crumb: '联系', h1: '先和 AI 演示聊，再和 Jack 聊。',
    sub: '不用填表。哪个方便用哪个。',
    cards: [
      ['打给 AI 演示', 'AI 演示 24 小时接，英语、西班牙语、中文都行。问问服务多少钱，再约个和 Jack 通话的时间。', DEMO_DISPLAY, `tel:${DEMO_TEL}`, 'demo_call_click', T.zh.cta.call, true],
      ...
      ['给 AI 演示发短信', 'AI 演示全天候回，也能直接帮你把通话约上。写上店名和你们做什么。', SMS_DISPLAY, `sms:${SMS_TEL}`, 'sms_click', '发短信到 ' + SMS_DISPLAY, false],
    ],
