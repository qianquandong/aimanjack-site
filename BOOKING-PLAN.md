...
现状（2026-09-09）：演示线 +1 (469) 517-2968 在 Twilio 账户 `car-sms-agent` 下，语音入口 `https://voice.aimanjack.com/voice-rt`，现在只能答问题，不能查空位、不能写预约。网站第二 CTA 因此暂时是「Email Jack」。
...
| 周 | 交付 | 验收 |
|---|---|---|
| W1 | D1 建表 + API + `/book/` 页面，只配 AI Man Jack 自己（一个 service：15 分钟通话） | 网页能约、改、取消；`BOOK_URL` 填上，站点重建，第二 CTA 变「Book a 15-min demo」 |
...
- AI 号码由 AI Man Jack 提供，取消后仍归 AI Man Jack；客户转接的自有号码只是关掉转接。
